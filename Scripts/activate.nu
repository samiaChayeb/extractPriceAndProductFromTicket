...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Applications\IA project\ExtractDataUsingImage'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Applications\IA project\ExtractDataUsingImage\Scripts\deactivate.nu'
